...
MedianFilter::MedianFilter(const uint8_t size, const int seed)
{

	medFilterWin = std::max((int)size, 3);			// number of samples in sliding median filter window - usually odd #
