...
const LogicalAddress la_RTC(1, 8);
const LogicalAddress la_DIGITAL_TEMP(1, 9);
const LogicalAddress la_ANALOG_TEMP1(1, 10);
const LogicalAddress la_ANALOG_TEMP2(1, 11);
